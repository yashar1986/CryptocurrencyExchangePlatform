...
export const ru: LangType = {
    ...
    'page.header.navbar.trade': 'خرید و فروش',
    ...
    'page.body.trade.header.newOrder.content.orderType.limit': ' لیمیت(سفارش محدود)',
    ...
    'page.body.trade.header.newOrder.content.total': 'قابل پرداخت',
