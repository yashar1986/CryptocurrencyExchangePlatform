...
export const ru: LangType = {
    'page.header.navbar.signIn': 'وارد شدن',
    'page.header.navbar.trade': 'بورس سهام',
    'page.header.navbar.wallets': 'کیف پول',
    'page.header.navbar.openOrders': 'سفارشات',
    'page.header.navbar.history': 'تاریخ',

    'page.header.navbar.profile': 'مشخصات',
    'page.header.navbar.logout': 'برو بیرون',

    'page.sidebar.group.text': 'گروه هزینه:',
    'page.sidebar.group.value': 'پایه',

    'page.body.trade.header.markets': 'بازارها',
    'page.body.trade.header.markets.content.pair': 'زن و شوهر',
    'page.body.trade.header.markets.content.price': 'قیمت',
    'page.body.trade.header.markets.content.change': 'تغییر 24 ساعته',
    'page.body.trade.header.markets.content.market': 'زن و شوهر',
    'page.body.trade.header.markets.content.last_price': 'آخرین قیمت',
    'page.body.trade.header.markets.content.search': 'جستجو کردن',
    'page.body.trade.header.markets.content.volume': 'جلد',

    'page.body.trade.header.newOrder': 'سفارش ایجاد کنید',
    ...
    'page.body.trade.header.newOrder.content.amount': 'عدد.',
    'page.body.trade.header.newOrder.content.total': 'جمع',
    'page.body.trade.header.newOrder.content.available': 'در دسترس',
    'page.body.trade.header.newOrder.content.filterPrice': 'مرحله معتبر قیمت {priceStep}',

    'error.order.create.minAmount': 'مقدار خیلی کم است. حداقل تعداد: {مقدار} {ارز}',
    'error.order.create.minPrice': 'قیمت خیلی پایین است حداقل قیمت: {قیمت} {ارز}',
    'error.order.create.maxPrice': 'قیمت خیلی بالاست حداکثر قیمت: {قیمت} {ارز}',
    'error.order.create.available': 'تعادل فراتر رفته است. در دسترس {موجود} {ارز}',

    'page.body.trade.header.marketDepths': 'عمق بازار',
    'page.body.trade.header.marketDepths.content.price': 'قیمت:',
    'page.body.trade.header.marketDepths.content.volume': 'جلد:',
    'page.body.trade.header.marketDepths.content.cumulativeVolume': 'حجم کلی:',
    'page.body.trade.header.marketDepths.content.cumulativeValue': 'ارزش کل:',

    'page.body.trade.toolBar.lowest': 'کمترین 24 ساعت',
    'page.body.trade.toolBar.lastPrice': 'آخرین قیمت',
    'page.body.trade.toolBar.selectMarket': 'بازار را انتخاب کنید',
    'page.body.trade.toolBar.highest': 'عالی ترین 24 ساعت',
    'page.body.trade.toolBar.volume': 'جلد 24 ساعته',
    'page.body.trade.toolBar.change': 'تغییرy55',

    'page.body.trade.header.asks': 'فروش سفارشات',
    'page.body.trade.header.bids': 'لوازم خرید',
    'page.body.trade.orderbook': 'سفارش کتاب',
    'page.body.trade.orderbook.lastMarket': 'آخرین قیمت بازار',
    'page.body.trade.orderbook.header.price': 'قیمت',
    'page.body.trade.orderbook.header.amount': 'عدد.',
    'page.body.trade.orderbook.header.volume': 'جلد',

    'page.body.trade.header.recentTrades': 'تاریخچه معاملات بازار',
    'page.body.trade.header.recentTrades.content.time': 'زمان',
    'page.body.trade.header.recentTrades.content.price': 'قیمت',
    'page.body.trade.header.recentTrades.content.amount': 'عدد.',
    'page.body.trade.header.market': 'معاملات بازار',
    'page.body.trade.header.yours': 'معاملات شما',
    ...
    'page.body.trade.header.openOrders.content.amount': 'عدد.',
    'page.body.trade.header.openOrders.content.total': 'جمع',
    'page.body.trade.header.openOrders.content.filled': 'پر شده',


    /* Markets Table */
    'page.body.marketsTable.filter.all': 'همه',
    'page.body.marketsTable.header.pair': 'فروشگاه',
    'page.body.marketsTable.header.lastPrice': 'آخرین قیمت',
    'page.body.marketsTable.header.change': '24 تغییر دهید',
    'page.body.marketsTable.header.high': '24 بلند',
    'page.body.marketsTable.header.low': '24 کم',
    'page.body.marketsTable.header.volume': '24 جلد',


    /* Landing */
    'page.body.landing.header.button1': 'مشخصات',
    'page.body.landing.header.button2': 'وارد شدن',
    ...
    'page.header.signIn': 'وارد شدن',
    'page.header.signIn.email': 'پست الکترونیکی',
    'page.header.signIn.password': 'کلمه عبور',
    'page.header.signIn.password.message.error': 'رمز عبور اشتباه است',
    'page.header.signIn.receiveConfirmation': 'ایمیل تأییدی دریافت نکردید؟',
    ...
    'page.header.signUp': 'ثبت',
    'page.header.signUp.email': 'پست الکترونیکی',
    'page.header.signUp.email.message.error': 'نامه نامعتبر است',
    'page.header.signUp.password': 'کلمه عبور',
    'page.header.signUp.password.message.error': 'رمز ورود باید حداقل شامل 8 حرف و حداقل یک حرف بزرگ و شماره باشد',
