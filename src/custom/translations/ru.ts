...
export const ru: LangType = {
  ...
  'error.order.create.minPrice': 'قیمت انتخابی مجاز نمی باشد. حداقل قیمت {قیمت} {currency}',
    ...
    'page.body.trade.header.marketDepths.content.cumulativeValue': 'ارزش دارایی',
    ...
    'page.body.trade.header.openOrders.content.filled': 'موفق',
    ...
    'page.body.landing.header.Market':"بازار",
    'page.body.landing.header.Trade':"تجارت",
    'page.body.landing.header.Finance':'سرمایه گذاری',


    'page.body.landing.platformInfo.item.first.value': '30M+',
    'page.body.landing.platformInfo.item.first.title': 'خدمت به مشتری',
    ...
    'page.body.landing.tradeOnTheGo.item.title': 'در حال انجام',
    ...
    'page.body.landing.footer.rights':' تمامی حقوق برای بانکدکس محفوظ است.',
    ...
    /* Wallets */
    'page.body.wallets.estimated_value': 'ارزش دارایی',

    'page.body.wallets.locked': 'قفل شده',
    'page.body.wallets.balance': 'موجودی',
    'page.body.wallets.tabs.deposit': 'واریز',
    'page.body.wallets.tabs.deposit.disabled.message': 'امکان واریز وجه از طرف مدیریت مسدود شده است ',
    'page.body.wallets.tabs.deposit.ccy.message.submit': 'با استفاده از کیوآر کد یا آدرس زیر اقدام به واریز کنید. مبلغ واریزی پس از انجام تاییدیه ها در حساب شما نمایش داده خواهد شد ',
    ...
    'page.body.wallets.tabs.deposit.ccy.button.generate': 'آدرس کیف پول من',
