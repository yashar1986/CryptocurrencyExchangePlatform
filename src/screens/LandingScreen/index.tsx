                ...
                <div className="pg-landing-screen__header__wrap">
                    <div className="pg-landing-screen__header__wrap__left" onClick={(e) => this.handleScrollTop()}>
                        ...
                        <Menu pointing secondary>
                            <Link to="/BuySell" className="pg-Link">
                                <Menu.Item>{this.translate('page.body.landing.header.BuySell')}</Menu.Item>
                            </Link>

                            <Link to="/Market" className="pg-Link">
                                <Menu.Item>{this.translate('page.body.landing.header.Market')}</Menu.Item>
                            </Link>
